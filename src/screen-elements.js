...
export const SCREEN_ELEMENTS = [
  ...
  [QUESTION, [
    ...
    ["question-prompt", "The block being asked about. A word, a phrase with a gap in it, or a play button, depending on the exercise.", ""],
  ...
  [ANSWER, [
    ["verdict", "What happened. Rotating praise when right; one fixed line when not.", "Nicely done! · Incorrect. The correct answer is: · The answer is:"],
    ...
    ["flag-menu-label", "The line at the top of that panel, naming what it is for.", "Flag a problem"],
    ["flag-note", "The block under Something else — the problem in your own words, there from the start.", ""],
