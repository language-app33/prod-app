...
const PLACES: Record<string, [string, string]> = {
  ...
  AgreementFields: [TEACH, "Editing a card · a word and the forms it takes beside a noun"],
  CellFields: [TEACH, "Editing a card · one form of a word, in the fewest boxes"],
