...
export default [
  { ignores: ["dist/**", "dev-dist/**", "node_modules/**", "tests/.smoke-build/**", "tests/.cards-build/**", "tests/.session-build/**", "tests/.offline-build/**", "tests/.pace-build/**", "tests/.facts-build/**", "tests/.readout-build/**"] },
